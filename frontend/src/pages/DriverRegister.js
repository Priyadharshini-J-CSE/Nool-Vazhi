...
export default function DriverRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await authAPI.registerDriver(form);
      login(data);
      navigate('/dashboard');
    } catch (err) {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.card} className="fade-in">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn-primary" style={{ width: '100%', justifyContent: 'center', padding: '14px', fontSize: 16, background: '#F97316', borderColor: '#F97316' }} disabled={loading}>
